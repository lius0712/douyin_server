...
func relationFollowerListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(relation.RelationFollowerRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
...
func (p *RelationFollowerListArgs) Unmarshal(in []byte) error {
	msg := new(relation.RelationFollowerRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var RelationFollowerListArgs_Req_DEFAULT *relation.RelationFollowerRequest

func (p *RelationFollowerListArgs) GetReq() *relation.RelationFollowerRequest {
	if !p.IsSetReq() {
...
type RelationFollowerListResult struct {
	Success *relation.RelationFollowerResponse
}

var RelationFollowerListResult_Success_DEFAULT *relation.RelationFollowerResponse

func (p *RelationFollowerListResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(relation.RelationFollowerResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *RelationFollowerListResult) Unmarshal(in []byte) error {
	msg := new(relation.RelationFollowerResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *RelationFollowerListResult) GetSuccess() *relation.RelationFollowerResponse {
	if !p.IsSetSuccess() {
...
func (p *RelationFollowerListResult) SetSuccess(x interface{}) {
	p.Success = x.(*relation.RelationFollowerResponse)
}
...
func (p *kClient) RelationFollowerList(ctx context.Context, Req *relation.RelationFollowerRequest) (r *relation.RelationFollowerResponse, err error) {
