...
type Client interface {
	...
	RelationFollowerList(ctx context.Context, Req *relation.RelationFollowerRequest, callOptions ...callopt.Option) (r *relation.RelationFollowerResponse, err error)
}
...
func (p *kRelationServiceClient) RelationFollowerList(ctx context.Context, Req *relation.RelationFollowerRequest, callOptions ...callopt.Option) (r *relation.RelationFollowerResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
